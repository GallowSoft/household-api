  ...
  async inventoryItem(
    ...
    return data
      ? {
          ...
          expirationDate: (data as any).expiration_date ? new Date((data as any).expiration_date) : null,
          purchaseDate: (data as any).purchase_date ? new Date((data as any).purchase_date) : null,
          costPerUnit: (data as any).cost_per_unit,
          storageLocation: (data as any).storage_location,
          isActive: (data as any).is_active,
          createdAt: (data as any).created_at ? new Date((data as any).created_at) : new Date(),
          updatedAt: (data as any).updated_at ? new Date((data as any).updated_at) : new Date(),
